...
Depois de bastante iteracao, a gente chegou numa versao esqueleto 0.1 de **The Last Arrow**.
...
Gravei um video rapido mostrando:

- como o projeto esta estruturado hoje
- as mecanicas basicas ja funcionando
- o que eu quero melhorar nas proximas versoes

Vou deixar o video aqui:

`COLE_O_LINK_DO_VIDEO_AQUI`

Hashtags opcionais:

`#gamedev #indiedev #unity #prototype #pvp #gamedevelopment`
